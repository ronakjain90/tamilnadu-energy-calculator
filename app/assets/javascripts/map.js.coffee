...
class LandUse
  ...
  setup: () ->
    ...
    target.append("<div id='land_map' style='background-image:url(../../assets/images/tamil03.svg);background-size: 100% 100%; background-repeat: no-repeat;' class='chart'></div>")
